    ...
    return (
        <div class="relative flex flex-col p-4 w-96 h-auto rounded bg-slate-900 shadow-black shadow-xl">
            ...
            <div class="flex w-full items-center justify-evenly my-2">
                {props.demo && <button onClick={() => window.open(props.demo)} class="bg-indigo-800 text-slate-300 h-10 w-16 rounded-lg font-medium shadow-md shadow-black hover:shadow-none">Demo</button>}
                <button onClick={() => window.open(props.github)} class="bg-indigo-800 text-slate-300 h-10 w-16 rounded-lg font-medium shadow-md shadow-black hover:shadow-none">Github</button>
            </div>
